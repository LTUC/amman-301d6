...
//all of them const except the changing ones
...
function displayPics(){
  ...
  //Errors that were thrown were because const is a value that cannot be changed. I recognized that const is not useful for setting i in a for loop, or anytime that the variable will change or be reassigned. let was good for this. 
