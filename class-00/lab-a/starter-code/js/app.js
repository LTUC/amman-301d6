...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the F letiable declaration from `let to `let`.
  // because rando was declared inside the function displayPics and its scope is locally and only inside the function
  console.log(viewed);
